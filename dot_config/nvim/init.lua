...
pcall(require, 'modules.options')
pcall(require, 'modules.config')
pcall(require, 'modules.keybind')
pcall(require, 'modules.autocommands')
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- Separate configuration for Typst
        vim.lsp.enable 'typst_lsp',
        -- Separate configuration for LSP_AI
